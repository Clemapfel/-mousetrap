...
namespace mousetrap
{
    ...
    template<typename T>
    WidgetImplementation<T>& WidgetImplementation<T>::operator=(WidgetImplementation<T>&& other) const
    {
        _native = other._native;
        other._native = nullptr;
        return *this;
    ...
    void Widget::add_tick_callback(Function_t f_in, Data_t data_in)
    {
        ...
        gtk_widget_add_tick_callback(operator GtkWidget*(), (GtkTickCallback) G_CALLBACK(tick_callback_wrapper), this, nullptr);
    }
